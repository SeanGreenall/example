...
<body class="h-full">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Robbie Robot</div>
                <div class="text-sm font-medium leading-none text-gray-400">Robbie@robot.com</div>
            </div>
    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
            ...
            @auth    
                <a href="/jobs/create"><button class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create Job</button></a>
            @endauth
        </div>
    </header>
    <main>
